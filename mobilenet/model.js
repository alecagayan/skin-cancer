skin_classes = {
    ...
    2: 'bkl, Benign Keratosis', // kinda bueno
    3: 'df, Dermatofibroma', // kinda bueno
    4: 'mel, Melanoma', // no bueno
    5: 'nv, Melanocytic Nevi', // kinda bueno
...
async function predict() {
    ...
    top5.forEach(function (p) {
        ...
        $("#lesion-results").append(`<li><span style='color:${color}'>${p.className}: ${p.probability.toFixed(1)*100}</span></li>`);
    });
